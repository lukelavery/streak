...
class CalendarPage extends ConsumerWidget {
  const CalendarPage({Key? key, this.streaks}) : super(key: key);
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Row(children: [
              Expanded(child: Text(days[0], textAlign: TextAlign.center,
            style: const TextStyle(
                fontFamily: 'Montserrat', fontWeight: FontWeight.w600))),
              Expanded(child: Text(days[1], textAlign: TextAlign.center,
            style: const TextStyle(
                fontFamily: 'Montserrat', fontWeight: FontWeight.w600))),
              Expanded(child: Text(days[2], textAlign: TextAlign.center,
            style: const TextStyle(
                fontFamily: 'Montserrat', fontWeight: FontWeight.w600))),
              Expanded(child: Text(days[3], textAlign: TextAlign.center,
            style: const TextStyle(
                fontFamily: 'Montserrat', fontWeight: FontWeight.w600))),
              Expanded(child: Text(days[4], textAlign: TextAlign.center,
            style: const TextStyle(
                fontFamily: 'Montserrat', fontWeight: FontWeight.w600))),
              Expanded(child: Text(days[5], textAlign: TextAlign.center,
            style: const TextStyle(
                fontFamily: 'Montserrat', fontWeight: FontWeight.w600))),
              Expanded(child: Text(days[6], textAlign: TextAlign.center,
            style: const TextStyle(
                fontFamily: 'Montserrat', fontWeight: FontWeight.w600))),
            ]),
            GridView.builder(
            ...
            style: const TextStyle(
                fontFamily: 'Montserrat', fontWeight: FontWeight.w500))
                                    : Text(
                                        ...
                                        style: TextStyle(color: Colors.grey, fontFamily: 'Montserrat', fontWeight: FontWeight.w500),
                                      ),
                            Spacer(
                              flex: 4,
                            ),
